...
{
	int quant, numero;
	printf("Vc deseja inserir quantos nï¿½meros na lista? \n");
	scanf("%d", &quant);
	...
	printf("\nDigite o número que vc deseja verificar quantos números existem na lista que são maiores que ele:  ");
	scanf("%d", &numero);
	return (numero);
}
...
int main()
{
	...
	do
	{
		...
		printf("3 - Mostrar a quantidade números na lista que são maiores que o número X\n");
		...
		case 3:
			...
			printf("A quantidade de números maiores que o número %d é: %d\n\n", numero, cont);
			break;
		}
		system("PAUSE");
		system("cls");
