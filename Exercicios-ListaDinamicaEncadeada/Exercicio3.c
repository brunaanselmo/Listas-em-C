...
int main()
{
	...
	do
	{
		...
		printf("3 - Mostrar a quantidade de vezes que um número X aparece na lista\n");
		...
		case 2:
			...
			break;
		case 3:
			printf("\nDigite o número que vc deseja ver a quantidade de vezes que ele aparece na lista:  ");
			scanf("%d", &numero);
			cont = Quant(&L1, numero);
			printf("\nA quantidade de vezes que o número %d aparece na lista é: %d\n\n", numero, cont);
			break;
		}
		system("PAUSE");
		system("cls");
